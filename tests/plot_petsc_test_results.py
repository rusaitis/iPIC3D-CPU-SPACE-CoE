#!/usr/bin/env python3
"""
plot_petsc_test_results.py — Generate solver comparison plots from results.csv.
...
from plot_results_common import load_results_csv, resolve_csv_path, resolve_plot_path
